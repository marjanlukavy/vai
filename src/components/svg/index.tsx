...
export const ChartIcon = ({ className }: { className: string }) => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <circle cx="20" cy="5" r="2" fill="black" fill-opacity="0.2" />
      <circle cx="5" cy="20" r="2" fill="black" fill-opacity="0.2" />
      <circle cx="16" cy="16" r="2" fill="black" fill-opacity="0.2" />
      <path
        d="M11 5L18 5"
        stroke="black"
        stroke-width="1.5"
      ...
      <circle
        ...
        stroke-width="1.5"
      />
      <circle cx="5" cy="20" r="2" stroke="black" stroke-width="1.5" />
      <circle cx="16" cy="16" r="2" stroke="black" stroke-width="1.5" />
      <circle cx="20" cy="5" r="2" stroke="black" stroke-width="1.5" />
    </svg>
  );
};
